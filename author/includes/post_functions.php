...
function createPost($request_values)
	{
		global $conn, $errors, $title, $topic_id, $body, $description, $keywords, $published, $user_id;
	...
	* * * * * * * * * * * * * * * * * * * * * */
	...
	{
		global $conn, $title, $post_slug, $body, $description, $keywords, $published, $isEditingPost, $post_id;
	...
	{
		global $conn, $errors, $post_id, $title, $topic_id, $body, $description, $keywords, $published;
